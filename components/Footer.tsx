...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-background border-t border-content/5 pt-20 pb-10 overflow-hidden z-10">
      {/* Gradient Line */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
               ...
               <h2 className="text-3xl font-display font-bold text-content">
                MSA UEMK
               </h2>
            </div>
          ...
          <div>
            <h3 className="font-display font-bold text-content mb-6">Explore</h3>
          ...
          <div>
            <h3 className="font-display font-bold text-content mb-6">Connect</h3>
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-content/5 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-primary hover:text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/20"
                >
                  <social.icon size={18} />
                </a>
              ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-content/5 text-gray-500 text-sm">

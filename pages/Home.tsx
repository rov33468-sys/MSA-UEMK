    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <Reveal delay={0.2}>
            <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-content/10 bg-surface/30 backdrop-blur-md hover:border-primary/50 transition-colors duration-300">
          ...
          <Reveal delay={0.4}>
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-7xl md:text-9xl font-display font-bold tracking-tighter mb-2 leading-none">
                <span className="text-content transition-colors duration-300">MSA</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary animate-gradient-x">UEMK</span>
              </h1>
              <h2 className="text-sm md:text-2xl font-display font-medium text-gray-500 tracking-[0.2em] md:tracking-[0.5em] uppercase mb-8 text-center w-full opacity-80">
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce text-gray-400 opacity-50">
           <div className="w-1 h-12 rounded-full border border-gray-500 p-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <Reveal direction="right">
                <h2 className="text-4xl md:text-5xl font-display font-bold mb-8 text-content">
              ...
              <Reveal direction="right" delay={0.4}>
                <ul className="space-y-4 mt-8">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-content group">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Reveal direction="left" delay={0.2}>
                <GlassCard className="translate-y-8 hover:-translate-y-2 transition-transform duration-500">
                   ...
                   <h3 className="text-xl font-bold mb-2 text-content">Build</h3>
                   <p className="text-gray-500 text-sm">Real projects that solve real problems.</p>
                </GlassCard>
              </Reveal>
              <Reveal direction="left" delay={0.3}>
                <GlassCard className="hover:-translate-y-2 transition-transform duration-500">
                   ...
                   <h3 className="text-xl font-bold mb-2 text-content">Ship</h3>
                   <p className="text-gray-500 text-sm">Deploy to production and scale globally.</p>
                </GlassCard>
              </Reveal>
              <Reveal direction="left" delay={0.4}>
                <GlassCard className="translate-y-8 hover:-translate-y-2 transition-transform duration-500">
                   <Cpu className="text-primary mb-4 w-8 h-8" />
                   <h3 className="text-xl font-bold mb-2 text-content">Learn</h3>
                   <p className="text-gray-500 text-sm">Master the latest tech stacks.</p>
                </GlassCard>
              </Reveal>
              <Reveal direction="left" delay={0.5}>
                <GlassCard className="hover:-translate-y-2 transition-transform duration-500">
                   <Globe className="text-green-400 mb-4 w-8 h-8" />
                   <h3 className="text-xl font-bold mb-2 text-content">Connect</h3>
                   <p className="text-gray-500 text-sm">Meet like-minded innovators.</p>
                </GlassCard>
              </Reveal>
            </div>
          </div>
      ...
      {/* Stats Section */}
      <section className="py-20 border-y border-content/5 bg-surface/30 relative">
            ...
            {STATS.map((stat, idx) => (
              <Reveal key={idx} delay={idx * 0.1} direction="up">
                <div className="text-center group cursor-default">
                  <div className="w-16 h-16 mx-auto bg-content/5 rounded-2xl flex items-center justify-center text-primary mb-4 group-hover:scale-110 group-hover:bg-primary/10 group-hover:text-accent transition-all duration-300 shadow-[0_0_20px_rgba(0,0,0,0.1)]">
                    <stat.icon size={32} strokeWidth={1.5} />
                  </div>
                  <h3 className="text-4xl md:text-5xl font-display font-bold text-content mb-2 tracking-tight">{stat.value}</h3>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 mb-12 flex justify-between items-end relative z-10">
          <Reveal direction="up">
            <div>
              <h2 className="text-4xl md:text-5xl font-display font-bold mb-4 text-content">Featured <span className="text-transparent bg-clip-text bg-gradient-to-r from-content to-gray-500">Events</span></h2>
              <p className="text-gray-500 dark:text-gray-400 text-lg max-w-md">Join us for workshops, hackathons, and networking sessions.</p>
            </div>
          </Reveal>
          <Reveal direction="left" delay={0.2}>
            <Link to="/events" className="hidden md:flex items-center gap-2 text-primary hover:text-content transition-colors group">
          ...
          {EVENTS.slice(0, 3).map((event, idx) => (
            <div key={event.id} className="min-w-[350px] md:min-w-[450px] snap-center">
              <Reveal delay={idx * 0.1} direction="left">
                <GlassCard className="h-full group hover:bg-content/5 transition-all duration-500 hover:-translate-y-2">
                  <div className="aspect-video rounded-lg overflow-hidden mb-6 relative">
                    ...
                    <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded text-xs font-bold uppercase border border-white/10 tracking-wider text-white">
                      {event.category}
                    </div>
                  </div>
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <h3 className="text-2xl font-bold text-content mb-2 group-hover:text-primary transition-colors">{event.title}</h3>
                    </div>
                  </div>

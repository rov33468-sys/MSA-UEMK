  ...
  <Reveal direction="up">
    <GlassCard className="p-0 overflow-hidden group h-full flex flex-col md:flex-row">
      ...
      <div className="p-6 md:p-8 flex flex-col justify-center relative w-full">
        ...
        <div className={`flex flex-wrap gap-4 text-sm mb-4 font-mono z-10 ${isPast ? 'text-gray-500' : 'text-accent'}`}>
        ...
        <h3 className={`text-2xl md:text-3xl font-display font-bold mb-4 z-10 ${isPast ? 'text-gray-400' : 'text-content'}`}>{event.title}</h3>
        <p className="text-gray-500 dark:text-gray-400 mb-8 z-10 leading-relaxed">{event.description}</p>
  ...
  return (
    <div className="pt-32 min-h-screen">
      <div className="container mx-auto px-6">
        <Reveal>
          <div className="mb-16">
            <h1 className="text-5xl md:text-7xl font-display font-bold mb-4 text-content">Events</h1>
            <p className="text-gray-500 dark:text-gray-400 text-lg">Where ideas collide and innovation happens.</p>
          </div>
        </Reveal>
        ...
        <div className="mb-32">
            <Reveal>
                <div className="flex items-center gap-4 mb-12">
                   ...
                   <h2 className="text-3xl font-display font-bold text-content">Upcoming Events</h2>
                </div>
            </Reveal>
            ...
            <div className="grid grid-cols-1 gap-12">
                {upcomingEvents.length > 0 ? (
                    ...
                    <div className="text-center py-20 border border-dashed border-content/10 rounded-2xl bg-content/5">
        ...
        <div className="mb-20">
            <Reveal>
                <div className="flex items-center gap-4 mb-12 opacity-60">
                    ...
                    <h2 className="text-3xl font-display font-bold text-content">Past Events</h2>
                </div>
            </Reveal>
